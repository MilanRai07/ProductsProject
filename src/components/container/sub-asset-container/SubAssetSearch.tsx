...
const SubAssetSearch: React.FC<props> = ({ setSearchParam, searchParam, id }) => {
    ...
    const { data, isFetching } = useGetProductsByParamQuery({ param, currentPage, limit, id });
            ...
            {isFetching ? (
                ...
                data?.items.length == 0 ? (
                    ...
                    >
                        ...
                        >
                            <Cross className="w-[50px] h-[50px] stroke-white cursor-pointer" />
                        </div>
